...
type Props = typeof resume.educations[0] & WithStyles<typeof styles>;

class Publication extends React.Component<Props> {

  render() {
    const { degree, timeperiod, location, description, classes } = this.props;

    return (
      <Card className={classes.content} elevation={3} square>
        <CardContent className={classes.innerContent}>
          <div className={classes.contentHeader}>
            <Typography component="h1">{degree}</Typography>
